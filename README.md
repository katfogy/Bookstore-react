...
**[Book Store]** This project is called Math-magicians. It is a wep app for Adding and Viewing Books.
...
```sh
  cd my-folder
  git git@github.com:katfogy/bookstore-react.git
```
-
...
Feel free to check the [issues page](https://github.com/katfogy/bookstore-react/issues).
